...
Raspberry Pi 3/3+/4 | This is a good starting point, and depending on the amount of devices you integrate this can be enough - use an [Class 10 or A1 class SD](https://www.amazon.com/SanDisk-Extreme-microSDHC-microSDXC-SDSQXA2-064G-GN6MA/dp/B06XWMMPGV) card if possible.
